...
const Footer = () => {
  ...
  const shareText = "🤑 Ever wonder how much celebrities REALLY make? Check out Wealth Perspective - mind-blowing earnings comparisons!";
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-full bg-muted/50 hover:bg-muted text-xs text-muted-foreground hover:text-foreground transition-colors"
            >
              Copy Link
            </button>
          </div>
