...
const ALL_SIDE_HUSTLES: SideHustleType[] = [
  ...
  { 
    ...
    guide: 'This is the ultimate low-effort, high-reward side hustle—share Wealth Perspective with your audience and earn cash for every signup. Here\'s the deal: your first 1,000 referrals earn $1 each, then you level up to $2 per signup forever after that. The math is insane: one TikTok that gets 100K views could drive 10,000 signups = $10,000-$20,000 depending on your tier. No inventory, no customer service, no skills required—just share and get paid. Step 1: Apply at earningsexplorer.shop/become-affiliate (takes 2 minutes, usually approved within 24 hours). Step 2: Get your unique referral link and branded QR code share card. Step 3: Create content showing off the app—film your reaction to celebrity earnings, do a comparison video, share your Reality Check results. TikTok, Instagram Reels, and YouTube Shorts are goldmines for this. The app sells itself because it\'s genuinely fun and mind-blowing. Pro tip: Post during peak hours (7-9pm), use trending sounds, and hook viewers in the first second. Grind to 1,000 referrals fast and unlock that $2/signup tier—this could literally pay your rent from one viral post!'
  },
  { 
