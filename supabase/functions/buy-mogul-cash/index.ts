...
serve(async (req) => {
  ...
  try {
    ...
    // Get user from auth header (optional - guests can also buy)
    ...
    console.error("Error creating Mogul Cash checkout:", error);
