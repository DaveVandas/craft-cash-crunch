...
const PAGE_META: Record<string, PageMeta> = {
  ...
  "landing-a": {
    ...
    description: "While you work 40 hours, Elon Musk makes what you'll earn in 10 lifetimes. See celebrity earnings in real-time.",
    staticImage: "/og-image.png",
    path: "/landing/a",
  },
  "landing-b": {
    title: "Your Wealth Reality Check | Wealth Perspective",
    description: "Compare your salary to any celebrity in real-time. The numbers will shock you. Try the free calculator now.",
    staticImage: "/og-image.png",
    path: "/landing/b",
  },
  "landing-c": {
    title: "See Money Differently | Wealth Perspective",
    description: "Watch billionaire earnings tick up by the second. Mind-blowing wealth comparisons that change how you see money.",
    staticImage: "/og-image.png",
    path: "/landing/c",
  },
  "landing-d": {
    title: "One TikTok Could Pay You $39,000 | Wealth Perspective",
    description: "Join the mogul movement. Share viral wealth content and earn cash for every friend who signs up. Start earning today!",
    staticImage: "/og-affiliate.png",
    path: "/landing/d",
  },
};
